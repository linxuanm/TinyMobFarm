...
public class Info {
	public static final String MOD_ID = "idleloot";
	public static final String NAME = "Idle Loot";
	public static final String VERSION = "1.0.0";
	public static final String MC_VERSIONS = "[1.12.2]";
	public static final String CLIENT_PROXY = "cn.davidma.idleloot.proxy.ClientProxy";
	public static final String COMMON_PROXY = "cn.davidma.idleloot.proxy.CommonProxy";
	...
	public static final int DURABILITY_COST_FROM_GENERATOR_ID(int id, Random rand) {
		
		// Oh wow that was a long name.
		return choice(STATS[id], rand);
	}
	
	public static final List<String> TOOLTIP_FROM_GENERATOR_ID(int id) {
		
		// Terrible formatting but meh.
		String[] setup = {
			"Generates loot every " + IdleLootConfig.GENERATOR_SPEED[id] + " seconds.",
